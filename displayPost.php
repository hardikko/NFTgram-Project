...
}else if($val == 'By Likes High to Low'){
    $g = "select * from post  ORDER BY likes DESC LIMIT $newCount";

}else if($val == 'By Likes Low to High'){
    $g = "select * from post  ORDER BY likes ASC LIMIT $newCount";
