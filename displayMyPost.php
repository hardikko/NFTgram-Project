...
?>
      <div class="main-element" id="<?php echo $row['token_id'];?>">
                            ...
                            <div class="post-info">
                                ...
                                <button title = "<?php echo $row['token_id'];?>"  class="unlist buy red-bg">unlist</button>
...
<script>
        ...
        $('.unlist').on("click",function(){
            var token = $(this).attr("title");
            confirm("Do you want to unlist post => token-id"+token);
            $.post("unlist.php",
            {   data:token,
                how:'s'
            },
            function(data){
                if(data){
                   ...
                   alert("post with token-id :  "+token+"unlisted");
                   location.reload();
