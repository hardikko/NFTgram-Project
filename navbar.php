...
echo'
        ...
        <div class="nav-links">
            ...
            <li><a title = "Get info about other NFTs and ownership"  href="./Block.php">Block Explore</a></li>
            <li><a title = "User Guide for new users"  href="./userGuide.html">User Guide</a></li>
            <!-- <li>About</li> -->
        </div>';
    }
